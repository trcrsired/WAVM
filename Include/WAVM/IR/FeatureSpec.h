...
#define WAVM_ENUM_NONSTANDARD_FEATURES(V)                                                                                                                                  \
	...
	V(memtagMte,                                                                                                                                                           \
	  "memtag",                                                                                                                                                            \
	  "Memory Tagging (Use hardware MTE in async mode if supported or fall back to software emulation (memtag-soft)")                                                      \
	V(memtagMteSync,                                                                                                                                                       \
	  "memtag-sync",                                                                                                                                                       \
	  "Memory Tagging. (Use hardware MTE in sync mode (maybe slow) if supported or fall back to software emulation (memtag-soft)")
